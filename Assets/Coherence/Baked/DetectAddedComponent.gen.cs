...
namespace Coherence.Generated.Internal
{
	...
	public class DetectAddedComponentsSystem : SystemBase
	{
		...
		protected override void OnUpdate()
		{
			...
			Entities.WithAll<global::Coherence.Generated.Cube_Cube, Simulated>().WithNone<Cube_Cube_Sync>().ForEach((Entity entity, int entityInQueryIndex) =>
			{

				ecb.AddComponent(entityInQueryIndex, entity, new Cube_Cube_Sync
				{
					howImportantAreYou = 100,
					// 30Hz
					minSamplingTime = 0.033f
			...
			Entities.WithAll<global::Coherence.Generated.Player_Controller, Simulated>().WithNone<Player_Controller_Sync>().ForEach((Entity entity, int entityInQueryIndex) =>
			{

				ecb.AddComponent(entityInQueryIndex, entity, new Player_Controller_Sync
				{
					howImportantAreYou = 100,
					// 30Hz
					minSamplingTime = 0.033f
