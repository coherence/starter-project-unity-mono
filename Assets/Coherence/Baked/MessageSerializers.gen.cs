...
namespace Coherence.Generated.Internal
{
	...
	public class MessageSerializers
	{
		...
		public void Player_Controller_Blaj(IOutBitStream bitstream, Player_Controller_Blaj data)
		{
			bitstream.WriteIntegerRange(data.frame, 15, -9999);
		}
		...
		public void Player_Controller_BlajRequest(IOutBitStream bitstream, Player_Controller_BlajRequest data)
		{
			bitstream.WriteIntegerRange(data.frame, 15, -9999);
		}
	}
