...
// Generated from schema 'Schema' [0x387BD19D]
// File created by coherence-code-generator v0.0.4-a13
// Generated at time 2020-10-05T09:35:23Z
// </auto-generated>
...
{
	public const uint SchemaHash = 0x387BD19D;
}
...
public static class UnityReaders
{
	...
	public static uint Read(ref Player data, IInBitStream bitstream)
	{
            ...
            if (bitstream.ReadMask()) 
		{
			var coherenceField = bitstream.ReadShortString();
			     data.prefab = CoherenceToUnityConverters.ToUnityNativeString64(coherenceField);
			propertyMask |= 0b00000000000000000000000000000001;
		}
	...
	public static uint Read(ref GenericFieldString0 data, IInBitStream bitstream)
	{
		...
		{
			var coherenceField = bitstream.ReadShortString();
			     data.name = CoherenceToUnityConverters.ToUnityNativeString64(coherenceField);
			propertyMask |= 0b00000000000000000000000000000001;
		}
		...
		public static void Write(in Rotation data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
		{
			...
			public static void Write(in Player data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
			{
				...
				if (bitstream.WriteMask((propertyMask & 0x01) != 0))
				{
						...
						var v = CoherenceToUnityConverters.FromUnityNativeString64(data.prefab);
			...
			public static void Write(in GenericFieldString0 data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
			{
				...
				if (bitstream.WriteMask((propertyMask & 0x01) != 0))
				{
						...
						var v = CoherenceToUnityConverters.FromUnityNativeString64(data.name);
						bitstream.WriteShortString(v);
...
public static class MessageSerializers
{
	...
	public static void Player(IOutBitStream bitstream, Player data)
	{
				...
				var converted_prefab = CoherenceToUnityConverters.FromUnityNativeString64(data.prefab);
	...
	public static void GenericFieldString0(IOutBitStream bitstream, GenericFieldString0 data)
	{
				...
				var converted_name = CoherenceToUnityConverters.FromUnityNativeString64(data.name);
...
public static class MessageDeserializers
{
	...
	public static void Player(IInBitStream bitstream, ref Player data)
	{
				...
				data.prefab = CoherenceToUnityConverters.ToUnityNativeString64(prefab);
	...
	public static void GenericFieldString0(IInBitStream bitstream, ref GenericFieldString0 data)
	{
				...
				data.name = CoherenceToUnityConverters.ToUnityNativeString64(name);
