...
namespace Coherence.Generated.Internal
{
    ...
    public class SerializeComponentUpdatesGenerated
    {
        ...
        private void SerializePlayer_Controller(EntityManager EntityManager, Entity entity, uint mask, IOutBitStream protocolOutStream)
        {
            // Write component changes to output stream
        ...
        public void SerializeComponent(EntityManager entityManager, Entity unityEntity, uint componentType, uint fieldMask, IOutBitStream protocolOutStream)
        {
            switch (componentType)
            {
                ...
                case TypeIds.InternalPlayer_Controller:
                    SerializePlayer_Controller(entityManager, unityEntity, fieldMask, protocolOutStream);
                    break;
