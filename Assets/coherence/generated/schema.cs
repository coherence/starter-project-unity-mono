...
// Generated from schema 'Schema' [0x95E43939]
...
{
	public const uint SchemaHash = 0x95E43939;
}
...
namespace Coherence.Generated.Internal.Schema
{
    ...
    public class DetectAddedComponentsSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            Entities.WithAll<global::Coherence.Generated.FirstProject.GenericScale, CoherenceSimulateComponent>().WithNone<GenericScale_Sync>().ForEach((Entity entity) =>
			{
...
namespace Coherence.Generated.Internal.Schema
{
    ...
    public class DetectChangedComponentsSystem : SystemBase
    {
	    protected override void OnUpdate()
	    {
			...
			Entities.ForEach((Entity entity, ref GenericScale_Sync sync, in global::Coherence.Generated.FirstProject.GenericScale data, in CoherenceSimulateComponent simulate) =>
			{
				uint mask = 0;
				if (!sync.hasBeenSerialized) 
				{ 
...
namespace Coherence.Generated.Internal.Schema
{
    ...
    public class DetectRemovedComponentsSystem : SystemBase
    {
        protected override void OnUpdate()
        {
			...
			Entities.WithNone<global::Coherence.Generated.FirstProject.GenericScale>().ForEach((Entity entity, ref GenericScale_Sync sync, in CoherenceSimulateComponent sim) =>
            {
                if (sync.deleteHasBeenSerialized)
                {
                    return;
