...
public class MessageDeserializers
{
	...
	public void InputClient(IInBitStream bitstream, ref InputClient data)
	{
	...
	public void InputClientCommand(IInBitStream bitstream, ref InputClientCommand data)
	{

			
				var inputs = bitstream.ReadShortString();
				data.inputs = coherenceToUnityConverters.ToUnityFixedString64(inputs);
