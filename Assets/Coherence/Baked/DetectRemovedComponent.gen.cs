...
namespace Coherence.Generated.Internal
{
	...
	public class DetectRemovedComponentsSystem : SystemBase
	{
		...
		protected override void OnUpdate()
		{
			...
			Entities.WithNone<global::Coherence.Generated.Cube_Cube>().ForEach((Entity entity, int entityInQueryIndex, ref Cube_Cube_Sync sync, in Simulated sim) =>
			{
				...
				commandBufferWriter.RemoveComponent<Cube_Cube_Sync>(entityInQueryIndex, entity);
			}).ScheduleParallel();

			Entities.WithNone<global::Coherence.Generated.Player_Controller>().ForEach((Entity entity, int entityInQueryIndex, ref Player_Controller_Sync sync, in Simulated sim) =>
			{
				...
				commandBufferWriter.RemoveComponent<Player_Controller_Sync>(entityInQueryIndex, entity);
			}).ScheduleParallel();
